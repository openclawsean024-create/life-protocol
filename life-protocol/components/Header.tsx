      ...
      <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
        ...
        <div className="hidden gap-3 md:flex items-center">
          ...
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-md border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
          >
            {theme === "dark" ? (
